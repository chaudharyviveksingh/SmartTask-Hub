# SmartTask Hub – Team Task Manager 🚀
...
```bash
git clone https://github.com/yourusername/SmartTask Hub.git
cd SmartTask Hub
```
...
```env
PORT=5000
MONGO_URI=mongodb+srv://<user>:<password>@cluster0.xxxxx.mongodb.net/SmartTask Hub
...
| Role | Email | Password |
|------|-------|----------|
| Admin | admin@SmartTask Hub.com | admin123 |
| Member | member@SmartTask Hub.com | member123 |
