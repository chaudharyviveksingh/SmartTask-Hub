...
const testimonials = [
  { name: 'Priya Sharma', role: 'Product Manager', text: 'SmartTask Hub completely transformed how our team manages sprints. The kanban view is chef\'s kiss.', rating: 5 },
  ...
  { name: 'Neha Gupta', role: 'Startup Founder', text: 'We replaced Jira with SmartTask Hub and never looked back. Setup took 10 minutes.', rating: 5 },
];
    ...
    <div className="min-h-screen bg-[#0F172A] text-white overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5 border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-bold text-xl tracking-tight">SmartTask Hub</span>
        </div>
          ...
          <div className="glass-card p-1 overflow-hidden" style={{ boxShadow: '0 0 80px rgba(99,102,241,0.2)' }}>
            <div className="bg-[#0F172A] rounded-xl p-6 text-left">
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="ml-3 text-slate-500 text-sm">SmartTask Hub Dashboard</span>
              </div>
      ...
      <section className="relative z-10 px-6 py-20 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="max-w-2xl mx-auto glass-card p-12" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.15), rgba(139,92,246,0.1))' }}>
            ...
            <p className="text-slate-400 mb-8">Join thousands of teams already using SmartTask Hub</p>
      ...
      <footer className="relative z-10 text-center py-6 border-t border-white/5 text-slate-500 text-sm">
        © 2025 SmartTask Hub. Built with ❤️ using MERN Stack.
      </footer>
    </div>
  );
}
